...
parser.add_argument(
    "--model_name", type=str, default="train_subj8_001",
...
parser.add_argument(
    "--subj", type=int, default=8, choices=[1, 2, 3, 4, 5, 6, 7, 8],
...
parser.add_argument(
    "--num_sessions", type=int, default=30,
...
parser.add_argument(
    "--resume_ckpt_name", type=str, default=None,
)
...
logging.basicConfig(filename=outdir+'/log.txt', level=logging.INFO, filemode='a')
...
def load_ckpt(ckpt_name, load_lr=True, load_optimizer=True, load_epoch=True, strict=True, outdir=outdir,
              multisubj_loading=False):
    print(f"\n---loading {outdir}/{ckpt_name}.pth ckpt---\n")
...
if resume:
    ...
    load_ckpt(ckpt_name=resume_ckpt_name, load_lr=True, load_optimizer=False, load_epoch=True, strict=True, outdir=outdir, multisubj_loading=False)
...
for epoch in progress_bar:
    ...
    logging.info("finish, logs of current epoch as follow:")
    logging.info(logs)
